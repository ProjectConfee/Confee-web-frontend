...
const Navbar_oc = () => {
    ...
    const Menus = [
        ...
        },
        {
            title: "Schedule",
            src: "schedule",
            path: "/committee_update_schedule",
            gap: true
        },
        {
            title: "Announcement",
            src: "announcement",
            path: "/committee_announcement",
            gap: true
        },
        ...
        // { title: "Winners", src: "winner", path: "/add_winners", gap: true },
        {
            ...
            src: "upload_resource",
            path: "/committee_upload_resource",
            gap: true
        },
        {
            title: "Feedback",
            src: "feedback",
            path: "/committee_feedback",
            gap: true
        },
        {
            title: "Logout",
            ...
            <div className="w-64 bg-white h-screen p-5 pt-8 relative">
                ...
                <ul className="pt-0">
                    {Menus.map((menu, index) => (
                        <li
                            key={index}
                            className={`flex rounded-md p-2 cursor-pointer hover:bg-[#3572EF] hover:rounded-r-3xl hover:text-white text-black text-m items-center gap-x-4 
                            ${menu.gap ? "mt-3" : "mt-2"}`
                            }
                        >
                            <Link
                            ...
                            >
                                ...
                                <span
                                    className={`${!open && "hidden"} origin-left duration-200 group-hover:text-white`}
                                >
                                {menu.title}
                </span>
                            </Link>
