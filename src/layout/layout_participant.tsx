...
const Layout_participant: React.FC<MainLayoutProps> = ({ children }) => {
  return (
    <div className="flex min-h-screen bg-slate-100">
      {/* Sidebar */}
      <div className="fixed top-0 left-0 h-full w-72 bg-white shadow-lg z-10">
        <Navbar_participant />
      </div>
      ...
      <div className="flex flex-col flex-grow ml-64">
        {/* Fixed Red Bar */}
        {/*<div className="fixed top-0 left-60 right-0 h-24 bg-slate-100 z-10 "></div>*/}

        {/* Topbar */}
        <div className="fixed top-4 left-80 right-8 h-16 bg-white shadow-md z-20 flex items-center justify-between px-4 rounded-xl">
        ...
        {/* Main Content Area */}
        <main className="pt-20 px-4"> {/* Adjusted top padding */}
