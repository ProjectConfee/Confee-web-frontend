...
import Navbar_admin from '../components/Navbar_admin.tsx';
...
const Layout_admin: React.FC<MainLayoutProps> = ({ children }) => {
    ...
    return (
        <div className="flex min-h-screen bg-slate-50">
            ...
            <div className="flex flex-col flex-grow">
                <div className="w-full fixed top-0 left-0 flex items-center justify-between px-6 bg-blue-800 text-white z-20"
                     style={{ height: '65px' }}
                >
