...
const Profile: React.FC = () => {
    ...
    return (
        <div className="flex px-8 space-x-8">
            ...
            <div className="w-1/4 px-4 py-24 bg-white rounded-2xl shadow-lg">
                <div className="flex flex-col items-center">
                    <img src={profilePhoto} alt="Profile" className="w-32 h-32 rounded-full mb-8" />
                    <h2 className="text-xl font-semibold mb-2">{name}</h2>
                    <p className="text-gray-500 mb-12">{personalDetails.email}</p>
                    <div className="space-y-2 text-center">
                        <Link to="/speaker_edit_profile">
                            <button className="w-3/4 py-2 bg-blue-500 text-white rounded-2xl mb-2">Edit Profile</button>
                        </Link>
                        <button className="w-3/4 py-2 bg-blue-500 text-white rounded-2xl mt-2" onClick={handleChangePassword}>Change Password</button>
                    </div>
                </div>
            </div>
            ...
            <div className="w-1/2 space-y-8">
                ...
                <div className="p-4 bg-white rounded-lg shadow-lg">
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between">
                            ...
                            <p className="text-left"><strong>Gender:</strong> {personalDetails.gender}</p>
                        </div>
                        <div className="flex justify-between">
                            <p><strong>Country:</strong> {personalDetails.country}</p>
                            <p className="text-left"><strong>Phone:</strong> {personalDetails.phone}</p>
                        </div>
                        <div className="flex justify-between">
                            <p><strong>Company:</strong> {personalDetails.company}</p>
                            <p className="text-left"><strong>Position:</strong> {personalDetails.position}</p>
                        </div>
                ...
                <div className="p-4 bg-white rounded-lg shadow-lg">
                    ...
                    <div className="space-y-2">
                        <p><strong>Qualifications:</strong> {professionalDetails.qualifications}</p>
                        <p><strong>LinkedIn:</strong> <a href={professionalDetails.linkedin} className="text-blue-500" target="_blank" rel="noopener noreferrer">{professionalDetails.linkedin}</a></p>
                        <p><strong>GitHub:</strong> <a href={professionalDetails.github} className="text-blue-500" target="_blank" rel="noopener noreferrer">{professionalDetails.github}</a></p>
                    </div>
                </div>
            </div>
            ...
            <Modal
                ...
                footer={[
                    ...
                    <Button key="save" type="primary" onClick={handleSaveUpload}>
                        Save
                    </Button>,
                ]}
            >
                ...
                >
                    ...
                    <Form.Item
                        name="resourceFile"
                        label="Resource File"
                        rules={[{ required: true, message: 'Please upload the resource file!' }]}
                    >
                        <Upload name="resourceFile" listType="text" maxCount={1}>
