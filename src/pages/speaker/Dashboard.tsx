            ...
            <div className="flex justify-between items-start p-4">
                ...
                <div className="w-3/5">
                    ...
                    <div className="flex items-center mb-8">
                        <IoIosArrowDropleftCircle className="text-gray-600 cursor-pointer mr-4" size={32} />
                        ...
                        <IoIosArrowDroprightCircle className="text-gray-600 cursor-pointer ml-4" size={32} />
                    </div>
                    ...
                    <div className="bg-white shadow-md rounded-2xl px-10 py-5">
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="bg-blue-50 shadow-md rounded-2xl p-4">
                                <h3 className="text-xl font-bold">Session 1</h3>
                                <p><strong>Topic: </strong>Introduction to React</p>
                                <p><strong>Date: </strong> 6th November 2024</p>
                                <p><strong>Time: </strong> 10:00 AM - 12:00 PM</p>
                                <p><strong>Location: </strong> Room A</p>
                            </div>
                            {/* Session Card 2 */}
                            <div className="bg-blue-50 shadow-md rounded-2xl p-4">
                                <h3 className="text-xl font-bold">Session 2</h3>
                                <p><strong>Topic: </strong>Advanced TypeScript</p>
                                <p><strong>Date: </strong> 7th November 2024</p>
                                <p><strong>Time: </strong> 2:00 PM - 4:00 PM</p>
                                <p><strong>Location: </strong> Room B</p>
                            </div>
                            <div className="bg-blue-50 shadow-md rounded-2xl p-4">
                                <h3 className="text-xl font-bold">Session 3</h3>
                                <p><strong>Topic: </strong>UI/UX Design Principles</p>
                                <p><strong>Date: </strong> 8th November 2024</p>
                                <p><strong>Time: </strong> 2:00 PM - 4:00 PM</p>
                                <p><strong>Location: </strong> Room A</p>
                            </div>
