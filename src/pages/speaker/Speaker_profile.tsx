...
const data1 = [
    'Company: UCSC',
    'Position: Staff',
    'Description: Conducting research, and writing papers, proposals, journal articles, and books.',
];
        ...
        <div className="flex justify-center h-screen">
            <div className="bg-white h-[500px] shadow-2xl w-4/5 mx-20 rounded-3xl mt-10">
                <div className="flex items-center pt-5">
                    ...
                    <Link to="/change_password_speaker">
                ...
                <div className="mt-5 flex justify-around">
                    ...
                    <div className="w-3/5 flex flex-col justify-evenly text-xl font-semibold">
