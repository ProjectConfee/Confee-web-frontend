                ...
                >
                    <div className={"flex flex-row justify-between"}>
                        ...
                        <div className={"flex items-center gap-4"}>
                            <Button type="primary" size="large" style={{backgroundColor: '#007bff',cursor: 'not-allowed'}}>
                                Completed
                            </Button>
                        </div>
                    </div>
            ...
            >
                <div className={"flex flex-row justify-between"}>
                    <div className={"flex flex-col"}>
                        ...
                        <div>
                            <Title level={5} style={{color: "#060C93"}}>
                                Inauguration and Introduction of ICTer 2023
                            </Title>
                        </div>
                    ...
                    <div className={"flex flex-col"}>
                        ...
                        <div className={"flex"}>
                            ...
                            <div>
                                ...
                                <div>
                                    <Text className={"text-base"} style={{color: "#060C93"}}>University of Colombo
                                        School of Computing</Text>
                                </div>
                                <div>
                                    <Text className={"font-bold"} style={{color: '#878787'}}>When Machines Go Rogue: The
                                        Risks and Rewards of AI Hallucination</Text>
                                </div>
                            </div>
                        </div>
                ...
                <div className={"flex flex-row justify-between"}>
                    <div className={"flex flex-col"}>
                        ...
                        <div>
                            ...
                            <Text className={"font-bold"} style={{color: '#878787'}}>Demystify Zero Downtime
                                Upgrades</Text>
                        </div>
            ...
            >
                <div className={"flex flex-row justify-between"}>
                    <div className={"flex flex-col"}>
                        ...
                        <div>
                            <Title level={5} style={{color: "#060C93"}}>Tech Talk: Altria Consulting & WIA Systems
                                Inc.</Title>
                            <Text className={"font-bold"} style={{color: '#878787'}}>Cloud ERP: The Benefits And
                                Challenges Of Adopting Cloud-Based Solutions</Text>
                        </div>
                    ...
                    <div className={"flex flex-col"}>
                        ...
                        <div className={"flex"}>
                            ...
                            <div>
                                ...
                                <div>
                                    <Text className={"text-base"} style={{color: "#060C93"}}>Mohamed bin Zayed
                                        University of Artificial Intelligence</Text>
                                </div>
                                <div>
                                    <Text className={"font-bold"} style={{color: '#878787'}}>Fairness in Artificial
                                        Intelligence</Text>
                                </div>
                            </div>
                        </div>
            ...
            >
                <div className={"flex flex-row justify-between"}>
                    <div className={"flex flex-col"}>
                        ...
                        <div>
                            <Title level={5} style={{color: "#060C93"}}>Tech Talk: Softlogic Information Technologies
                                (Pvt) Ltd & Dell Technologies</Title>
                            <Text className={"font-bold"} style={{color: '#878787'}}>EDGE, NFVI and Telecom
                                Future</Text>
                        </div>
                    ...
                    <div className={"flex flex-col"}>
                        ...
                        <div className={"flex"}>
                            ...
                            <div>
                                ...
                                <div>
                                    <Text className={"text-base"} style={{color: "#060C93"}}>Associazione
                                        LibreItalia</Text>
                                </div>
                                <div>
                                    <Text className={"font-bold"} style={{color: '#878787'}}>LibreOffice Technology, a
                                        FOSS platform for personal productivity</Text>
                                </div>
                            </div>
                        </div>
